...
const SAMPLE_CONVERSATIONS: Record<string, ChatMessage[]> = {
  ins1: [
    ...
    { id: "s2", from: "consultant", text: "Not yet, I was finishing up the assignment from Module 1.", sentAt: ago(60 * 24 * 10 - 15) },
    ...
    { id: "s4", from: "consultant", text: "Will do, thanks!", sentAt: ago(60 * 24 * 9 - 5) },
    ...
    { id: "s6", from: "consultant", text: "Yeah I finished it yesterday. Had a question about the DCF assumptions though, can I send you my spreadsheet?", sentAt: ago(60 * 24 * 2) },
    { id: "s7", from: "instructor", text: "Absolutely, just attach it in the next message or email it over.", sentAt: ago(60 * 24 * 2 - 30) },
    { id: "s8", from: "consultant", text: "Sent it to your email just now.", sentAt: ago(180) },
  ...
  ins2: [
    ...
    { id: "s11", from: "consultant", text: "Thank you! I'm excited to get started.", sentAt: ago(60 * 24 * 13) },
    ...
    { id: "s13", from: "consultant", text: "Quick question, is the quiz timed?", sentAt: ago(60 * 5) },
    { id: "s14", from: "instructor", text: "No, you can take as long as you need. Focus on understanding the concepts.", sentAt: ago(3) },
  ],
  ins3: [
    { id: "s15", from: "consultant", text: "Hi, I noticed the grade for my written exam hasn't been posted yet.", sentAt: ago(60 * 24 * 4) },
    { id: "s16", from: "instructor", text: "I'm still reviewing the submissions, should have them graded by Friday.", sentAt: ago(60 * 24 * 4 - 45) },
    { id: "s17", from: "consultant", text: "Sounds good, no rush!", sentAt: ago(60 * 24 * 4 - 40) },
  ],
};
 ...
 * /internal/messages and /consultant/messages), so the surrounding sidebar
...
export default function InstructorChat({
  ...
  const send = () => {
    ...
    const next: ChatMessage[] = [
      ...messages,
      { id: `m-${Date.now()}`, from: "consultant", text, sentAt: new Date().toISOString() },
    ];
    setMessages(next);
                    ...
                    >
                      ...
                      <p
                        className={`m-0 mt-1 text-[10px] ${
                          m.from === "consultant" ? "text-white/70" : "text-muted-foreground"
                        }`}
                      >
